...
public class GameBoardFull extends GameBoard {
	...
	private CardCell cc1, c1, c2, cc3, c3, cc2;
	...
	private void initCardCells() {
		...
		c1 = new CardCell(Card.TYPE_CHANCE, "Chance 1");
		c2 = new CardCell(Card.TYPE_CHANCE, "Chance 2");
		cc3 = new CardCell(Card.TYPE_CC, "Community Chest 3");
		c3 = new CardCell(Card.TYPE_CHANCE, "Chance 3");
		cc2 = new CardCell(Card.TYPE_CC, "Community Chest 2");
	}
